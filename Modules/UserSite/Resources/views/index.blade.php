                    ...
                    <article class="hentry post video">
                        ...
                        <div class="post-video">
                            <div class="video-thumb">
                                <img src="{{ asset('olympus/img/video5.jpg')}}" alt="photo">
                ...
                <div class="ui-block">
                    ...
                    <ul class="comments-list">
                        <li class="comment-item">
                            <div class="post__author author vcard inline-items">
                                <img src="{{ asset('olympus/img/avatar10-sm.jpg')}}" alt="author">
                        ...
                        <li class="comment-item has-children">
                            ...
                            <ul class="children">
                                <li class="comment-item">
                                    <div class="post__author author vcard inline-items">
                                        <img src="{{ asset('olympus/img/avatar8-sm.jpg')}}" alt="author">
                                ...
                                <li class="comment-item">
                                    <div class="post__author author vcard inline-items">
                                        <img src="{{ asset('olympus/img/avatar2-sm.jpg')}}" alt="author">
                        ...
                        <li class="comment-item">
                            <div class="post__author author vcard inline-items">
                                <img src="{{ asset('olympus/img/avatar4-sm.jpg')}}" alt="author">
                ...
                <div class="ui-block">
                    ...
                    <article class="hentry post has-post-thumbnail shared-photo">
                        ...
                        <div class="post-thumb">
                            <img src="{{ asset('olympus/img/post-photo6.jpg')}}" alt="photo">
                        </div>
                    ...
                    <ul class="widget w-badges">
                        <li>
                            <a href="24-CommunityBadges.html">
                                <img src="{{ asset('olympus/img/badge1.png')}}" alt="author">
                                <div class="label-avatar bg-primary">2</div>
                            </a>
                        </li>
                        <li>
                            <a href="24-CommunityBadges.html">
                                <img src="{{ asset('olympus/img/badge4.png')}}" alt="author">
                            </a>
                        </li>
                        <li>
                            <a href="24-CommunityBadges.html">
                                <img src="{{ asset('olympus/img/badge3.png')}}" alt="author">
                                <div class="label-avatar bg-blue">4</div>
                            </a>
                        </li>
                        <li>
                            <a href="24-CommunityBadges.html">
                                <img src="{{ asset('olympus/img/badge6.png')}}" alt="author">
                            </a>
                        </li>
                        <li>
                            <a href="24-CommunityBadges.html">
                                <img src="{{ asset('olympus/img/badge11.png')}}" alt="author">
                            </a>
                        </li>
                        <li>
                            <a href="24-CommunityBadges.html">
                                <img src="{{ asset('olympus/img/badge8.png')}}" alt="author">
                            </a>
                        </li>
                        <li>
                            <a href="24-CommunityBadges.html">
                                <img src="{{ asset('olympus/img/badge10.png')}}" alt="author">
                            </a>
                        </li>
                        <li>
                            <a href="24-CommunityBadges.html">
                                <img src="{{ asset('olympus/img/badge13.png')}}" alt="author">
                                <div class="label-avatar bg-breez">2</div>
                            </a>
                        </li>
                        <li>
                            <a href="24-CommunityBadges.html">
                                <img src="{{ asset('olympus/img/badge7.png')}}" alt="author">
                            </a>
                        </li>
                        <li>
                            <a href="24-CommunityBadges.html">
                                <img src="{{ asset('olympus/img/badge12.png')}}" alt="author">
                            </a>
                        </li>
                    </ul>
                ...
                <ol class="widget w-playlist">
                    <li class="js-open-popup" data-popup-target=".playlist-popup">
                        <div class="playlist-thumb">
                            <img src="{{ asset('olympus/img/playlist6.jpg')}}" alt="thumb-composition">
                    ...
                    <li class="js-open-popup" data-popup-target=".playlist-popup">
                        <div class="playlist-thumb">
                            <img src="{{ asset('olympus/img/playlist7.jpg')}}" alt="thumb-composition">
                            <div class="overlay"></div>
                            <a href="#" class="play-icon">
                                <svg class="olymp-music-play-icon-big">
                                <use xlink:href="svg-icons/sprites/icons-music.svg#olymp-music-play-icon-big"></use>
                    ...
                    <li class="js-open-popup" data-popup-target=".playlist-popup">
                        <div class="playlist-thumb">
                            <img src="{{ asset('olympus/img/playlist8.jpg')}}" alt="thumb-composition">
                            <div class="overlay"></div>
                            <a href="#" class="play-icon">
                                <svg class="olymp-music-play-icon-big">
                                <use xlink:href="svg-icons/sprites/icons-music.svg#olymp-music-play-icon-big"></use>
                    ...
                    <li class="js-open-popup" data-popup-target=".playlist-popup">
                        <div class="playlist-thumb">
                            <img src="{{ asset('olympus/img/playlist9.jpg')}}" alt="thumb-composition">
                            <div class="overlay"></div>
                            <a href="#" class="play-icon">
                                <svg class="olymp-music-play-icon-big">
                                <use xlink:href="svg-icons/sprites/icons-music.svg#olymp-music-play-icon-big"></use>
                    ...
                    <li class="js-open-popup" data-popup-target=".playlist-popup">
                        <div class="playlist-thumb">
                            <img src="{{ asset('olympus/img/playlist10.jpg')}}" alt="thumb-composition">
                            <div class="overlay"></div>
                            <a href="#" class="play-icon">
                                <svg class="olymp-music-play-icon-big">
                                <use xlink:href="svg-icons/sprites/icons-music.svg#olymp-music-play-icon-big"></use>
                ...
                <ul class="widget w-twitter">
                    <li class="twitter-item">
                        <div class="author-folder">
                            <img src="{{ asset('olympus/img/twitter-avatar1.png')}}" alt="avatar">
                            <div class="author">
                ...
                <div class="ui-block-content">
                    ...
                    <ul class="widget w-last-video">
                        <li>
                            ...
                            <img src="{{ asset('olympus/img/video8.jpg')}}" alt="video">
                            <div class="video-content">
                        ...
                        <li>
                            ...
                            <img src="{{ asset('olympus/img/video7.jpg')}}" alt="video">
                            <div class="video-content">
            ...
            <div class="ui-block">
                ...
                <div class="ui-block-content">
                    ...
                    <ul class="widget w-last-photo js-zoom-gallery">
                        <li>
                            <a href="{{ asset('olympus/img/last-photo10-large.jpg')}}">
                                <img src="{{ asset('olympus/img/last-photo10-large.jpg')}}" alt="photo">
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('olympus/img/last-phot11-large.jpg')}}">
                                <img src="{{ asset('olympus/img/last-phot11-large.jpg')}}" alt="photo">
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('olympus/img/last-phot12-large.jpg')}}">
                                <img src="{{ asset('olympus/img/last-phot12-large.jpg')}}" alt="photo">
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('olympus/img/last-phot13-large.jpg')}}">
                                <img src="{{ asset('olympus/img/last-phot13-large.jpg')}}" alt="photo">
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('olympus/img/last-phot14-large.jpg')}}">
                                <img src="{{ asset('olympus/img/last-phot14-large.jpg')}}" alt="photo">
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('olympus/img/last-phot15-large.jpg')}}">
                                <img src="{{ asset('olympus/img/last-phot15-large.jpg')}}" alt="photo">
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('olympus/img/last-phot16-large.jpg')}}">
                                <img src="{{ asset('olympus/img/last-phot16-large.jpg')}}" alt="photo">
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('olympus/img/last-phot17-large.jpg')}}">
                                <img src="{{ asset('olympus/img/last-phot17-large.jpg')}}" alt="photo">
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('olympus/img/last-phot18-large.jpg')}}">
                                <img src="{{ asset('olympus/img/last-phot18-large.jpg')}}" alt="photo">
                            </a>
                        </li>
                    </ul>
            ...
            <div class="ui-block">
                ...
                <div class="ui-block-content">
                    ...
                    <ul class="widget w-faved-page js-zoom-gallery">
                        ...
                        <li>
                            <a href="#">
                                <img src="{{ asset('olympus/img/avatar24-sm.jpg')}}" alt="user">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('olympus/img/avatar36-sm.jpg')}}" alt="author">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('olympus/img/avatar35-sm.jpg')}}" alt="user">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('olympus/img/avatar34-sm.jpg')}}" alt="author">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('olympus/img/avatar33-sm.jpg')}}" alt="author">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('olympus/img/avatar32-sm.jpg')}}" alt="user">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('olympus/img/avatar31-sm.jpg')}}" alt="author">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('olympus/img/avatar30-sm.jpg')}}" alt="author">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('olympus/img/avatar29-sm.jpg')}}" alt="user">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('olympus/img/avatar28-sm.jpg')}}" alt="user">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('olympus/img/avatar27-sm.jpg')}}" alt="user">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('olympus/img/avatar26-sm.jpg')}}" alt="user">
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <img src="{{ asset('olympus/img/avatar25-sm.jpg')}}" alt="user">
                            </a>
                        </li>
                        <li class="all-users">
                            <a href="#">+74</a>
                        ...
                        <li>
                            <div class="skills-item">
                                ...
                                <ul class="friends-harmonic">
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('olympus/img/friend-harmonic1.jpg')}}" alt="friend">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('olympus/img/friend-harmonic3.jpg')}}" alt="friend">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('olympus/img/friend-harmonic4.jpg')}}" alt="friend">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('olympus/img/friend-harmonic6.jpg')}}" alt="friend">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                        ...
                        <li>
                            <div class="skills-item">
                                ...
                                <ul class="friends-harmonic">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('olympus/img/friend-harmonic12.jpg')}}" alt="friend">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('olympus/img/friend-harmonic13.jpg')}}" alt="friend">
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            <div class="skills-item">
                                ...
                                <ul class="friends-harmonic">
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('olympus/img/friend-harmonic14.jpg')}}" alt="friend">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                            <img src="{{ asset('olympus/img/friend-harmonic15.jpg')}}" alt="friend">
                                        </a>
                                    </li>
                                </ul>
                            </div>
