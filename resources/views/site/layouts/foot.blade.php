...
<script src="{{ asset('js/posts/Edit-comment.js') }}"></script>
<script src="{{ asset('js/posts/editpost.js') }}"></script>
...
<script>
    ...
    //     let user =data.user;
    //     $('.nots-container').append('    <li class="un-read">\n' +
    //         '                                        <div class="author-thumb">\n' +
    //         '                                            <img width="49px" class="shadow img-thumbnail img-circle" src="'+user.image+'"\n' +
    //         '                                                 alt="'+user.name+'">\n' +
    //         '                                        </div>\n' +
    ...
    //         '                                                                                  datetime="2004-07-24T18:18">'+moment().fromNowOrNow(new Date())+'</time></span>\n' +
    //         '                                        </div>\n' +
