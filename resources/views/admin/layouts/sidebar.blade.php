    ...
    <section class="sidebar ">
        <div class="page-sidebar  sidebar-nav">
            ...
            <ul id="menu" class="page-sidebar-menu">
                ...
                @if($user_all == 1)
                <li @if($name_list=='users' || $name_list=='roles')class="active"@endif  >
                    <a href="#">
...
<!--                        <li><a href="{{ route('admin.roles.create') }}">
                        ...
                        <li><a @if($name_list=='roles')class="active" id="active" @endif href="{{ route('admin.roles.index') }}">
...
<!--                        <li><a href="{{ route('admin.users.create') }}">
                        ...
                        <li @if($name_list=='users')class="active" id="active" @endif ><a href="{{ route('admin.users.index') }}">
