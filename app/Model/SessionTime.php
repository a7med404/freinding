...
//       $end='2018-11-16 23:59:59.999999';
    ...
    public static function DataMonth($month_num, $num, $state = 0) {
    ...
    public static function ALLDataMonth($state = 0) {
        $data_month = [];
        for ($month = 1; $month <= 9; $month++) {
            $month_num = '0' . $month;
            $num = '-' . $month_num;
            $data_month[] = SessionTime::DataMonth($month_num, $num, $state);
        }
        for ($last_month = 10; $last_month <= 12; $last_month++) {
            $month_num = '-' . $last_month;
            $data_month[] = SessionTime::DataMonth($last_month, $month_num, $state);
        }
        return $data_month;
    }
