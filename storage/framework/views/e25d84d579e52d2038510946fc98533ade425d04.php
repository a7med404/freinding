                ...
                <div class="row">
                    <div class="col col-lg-12 col-sm-12 col-12" style="background: white;">
                        ...
                        <div class="ui-block">
                            ...
                            <?php if(isset($checkuserimageid) && $checkuserimageid->status =='underprocess'): ?>
                                <div id="underprocessdiv">
                                    <div class="titlestatuswarn">UNDER REVIEW</div>
                                    <p class="desc">Your request under review , you'll receive a notification letting
                                        you know if your account has been verified or not. If your request is denied,
                            ...
                            <?php elseif(isset($checkuserimageid) &&$checkuserimageid->status =='unverified'): ?>
                                <div id="unverifieddiv">
                                    <img style="width: 80px;" src="<?php echo e(asset('olympus/img/refused.png')); ?>"  id="idimage">
                            ...
                            <?php elseif(isset($checkuserimageid) && $checkuserimageid->status =='verified'): ?>
                                <div id="verifieddiv">

                                    <img style="width: 80px;" src="<?php echo e(asset('olympus/img/success.png')); ?>"  id="idimage">
                            ...
                            <?php else: ?>
                                <div id="notuploaded">
                                    <form method="post" id="upload_form" enctype="multipart/form-data">
                                        ...
                                        <img src="<?php echo e(asset('olympus/img/imgid.png')); ?>"  class="classimg" id="idimage">
    ...
    $(document).ready(function () {
        ...
        $('#upload_form').on('submit', function (event) {
            ...
            $.ajax({
                ...
                url: "<?php echo e(route('postverify')); ?>",
                method: "POST",
