...
<div class="row">
    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="form-group label-floating">
            ...
            <?php echo Form::text('name', $user->name, array('placeholder' => 'User Name','class' => 'form-control','data-rangelength'=>'[3,100]')); ?>

        </div>
        <div class="form-group label-floating">
            <label class="control-label">Your Email</label>
            <?php echo Form::email('email', $user->email, array('placeholder' => 'Your Email','class' => 'form-control','required'=>'','data-parsley-type'=>"email")); ?>
    ...
    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="form-group label-floating">
            ...
            <?php echo Form::text('display_name', $user->display_name, array('placeholder' => 'Display Name','class' => 'form-control','data-rangelength'=>'[3,100]')); ?>
        ...
        <div class="form-group label-floating">
            ...
            <?php echo Form::text('phone', $user->phone, array('placeholder' => 'Phone','id'=>'phone','class' => ' user_phone_buy form-control')); ?>
    ...
    <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
        <div class="form-group label-floating is-select">
            ...
            <?php echo Form::text('nationality', $user->nationality, array('placeholder' => 'Nationality','id'=>'nationality','class' => 'selectpicker form-control')); ?>
    ...
    <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
        <div class="form-group label-floating is-select">
            ...
            <?php echo Form::text('address', $user->address, array('placeholder' => 'City','id'=>'address','class' => '  form-control')); ?>
    ...
    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="form-group label-floating">
            ...
            <?php echo Form::textarea('about_me', $user->about_me, array('placeholder' => 'About me','id'=>'about_me','rows'=>'3','class' => '  form-control')); ?>
...
<!--        <div class="form-group label-floating is-empty">
    ...
    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
        <div class="form-group label-floating">
            ...
            <?php echo Form::text('occupation', $user->occupation, array('placeholder' => 'Occupation','id'=>'occupation','class' => '  form-control')); ?>

        </div>
        <div class="form-group label-floating">
            <label class="control-label">Working at</label>
            <?php echo Form::text('address_jop', $user->address_jop, array('placeholder' => 'Working at','id'=>'address_jop','class' => '  form-control')); ?>
