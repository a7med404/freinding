            ...
            <div id="tag-post-section" hidden>
                <select class="js-example-basic-multiple" name="states[]" multiple="multiple"
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option id="tagselected<?php echo e($user->id); ?>" value="<?php echo e($user->id); ?>" data-image="<?php echo e($user->image); ?> "
                                data-text="<?php echo e($user->display_name); ?> " style="margin:5%"></option>
            ...
            <div id="newsfeed-items-grid">
                <div class="container" id="AreaForPost">
                    ...
                    <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div id="AllPostDiv<?php echo e($post->id); ?>" class="ui-block">
                            ...
                            <article class="hentry post video">
                                <div class="post__author author vcard inline-items">
                                    ...
                                    <div class="author-date">
                                        ...
                                        <?php if($post->taggedFriends): ?>
                                            <?php if($post->taggedFriends->count()==1): ?>
                                                <span>&nbsp;With&nbsp;<a><?php echo e($post->taggedFriends[0]->user->display_name); ?></a></span>
                                            <?php elseif($post->taggedFriends->count()==2): ?>
                                                <span>&nbsp;With&nbsp;<a><?php echo e($post->taggedFriends[0]->user->display_name); ?></a></span>
                                                <span>&nbsp;And&nbsp;<a><?php echo e($post->taggedFriends[1]->user->display_name); ?></a></span>
                                            <?php elseif($post->taggedFriends->count()>2): ?>
                                                <span>&nbsp;With&nbsp;<a><?php echo e($post->taggedFriends[0]->user->display_name); ?></a></span>
                                                <span>&nbsp;And&nbsp;<a><?php echo e($post->taggedFriends[1]->user->display_name); ?></a></span>
                                                <?php
                                                ...
                                                ?>
                                                <span title="<?php echo e($name); ?>">And <?php echo e($post->taggedFriends->count()-2); ?>
                                    ...
                                    <div class="more">
                                        ...
                                        <ul class="more-dropdown">
                                            ...
                                            <li>
                                                <a href="javascript:void(0)" class="post-delete" id="<?php echo e($post->id); ?>">Delete
                                                    Post</a>
                                            </li>
                                            <li>
                                ...
                                <p style="word-wrap: break-word;"><?php echo e($post->text); ?></p>
                            <?php if($post->type == 'picture'): ?>
                                <!--<div class="modal fade" id="open-photo-popup-v1<?php echo e($post->id); ?>" tabindex="-1"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="photo-item " style="display:block;">
                                            <img src="<?php echo e($file->store_name); ?>"
                                                                                 alt="photo">
                                    ...
                                    <div class="<?php echo e($post->files->count()>1?'swiper-container':""); ?>" data-slide="fade">
                                        <div class="swiper-wrapper">
                                            <?php $__currentLoopData = $post->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="swiper-slide">
                                                    <div class="photo-item" style="display:block;">
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        <!--  <a data-toggle="modal" data-target="#open-photo-popup-v1<?php echo e($post->id); ?>"
                                               href="#" class="full-block"></a>-->
                                        </div>
                                        <?php if($post->files->count()>1): ?>
                                            <svg class="btn-next-without olymp-popup-right-arrow">
                                                <use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-popup-right-arrow"></use>
                                            </svg>
                                                    ...
                                                    <div class="photo-item" style="display:block;">
                                                        ...
                                                        align-items: center;" class="video_post">
                                                            <video class="video_post_element my-video"
                                                                   ...
                                                                   src="<?php echo e($file->store_name); ?>"
                                                                    type="video/mp4"
                            ...
                            <!--<div class="post-additional-info inline-items">
                                    ...
                                    <a id="<?php echo e($post->id); ?>" class="post-add-icon inline-items post_reacts_users">
                                        <svg class="olymp-heart-icon">
                                            <use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-heart-icon"></use>
                                        </svg>
                                        <span id="reactions_count<?php echo e($post->id); ?>"><?php echo e($post->reactions->count()); ?></span>
                                    </a>


                                    <ul id="reactioners_photos<?php echo e($post->id); ?>" class="friends-harmonic">
                                      <?php ($liked=false); ?>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="names-people-likes" id="reactioners_name<?php echo e($post->id); ?>">
                                ...
                                <a href="#"><?php echo e($post->reactions[0]->user->display_name); ?></a>
                                    ...
                                    <div class="comments-shared">
                                        <a href="#" class="post-add-icon inline-items">
                                            ...
                                            <span id="comment_count<?php echo e($post->id); ?>"><?php echo e($post->comments_count); ?></span>
                                        </a>
                            ...
                            ?>
                                    <span id="engagement_count<?php echo e($post->id); ?>"><?php echo e($engagement); ?></span>
                                        </a>
                                    </div>
                                ...
                                <div class="post-additional-info form-inline post-control-button flex-container reaction">
                                    <a id="btn_react<?php echo e($post->id); ?>" class="btn btn-control btn_react_first "
                                       style="background-color: <?php echo e($liked?'red':''); ?>;">
                                    ...
                                    <ul id="reactioners_photos<?php echo e($post->id); ?>"
                                    ...
                                    <div class="post_reacts_users" id="<?php echo e($post->id); ?>"
                            ...
                            <!-- <div class="control-block-button post-control-button">
                                    <a id="btn_react<?php echo e($post->id); ?>" class="btn btn-control"
                                       style="background-color: <?php echo e($liked?'red':''); ?>">
                                        <svg class="olymp-like-post-icon">
                                            <use xlink:href="olympus/svg-icons/sprites/icons.svg#olymp-like-post-icon"></use>
                                        </svg>
                            ...
                            <!-- Comments -->
                            <ul class="comments-list comments-list--<?php echo e($post->id); ?>">
                                <?php if($post->newest_comment): ?>

                                    <li id="newestComment<?php echo e($post->id); ?>"
                                        class="comment-item Allcommentul<?php echo e($post->newest_comment->id); ?>">
                                        <div class="post__author author vcard inline-items">
                                            <img src="<?php echo e($post->newest_comment->user->image); ?>" alt="author">

                                            <div class="author-date">
                                                <a class="h6 post__author-name fn"
                                                   href="#"><?php echo e($post->newest_comment->user->display_name); ?></a>
                                                <div class="post__date">
                                                    <time class="published" datetime="2004-07-24T18:18">
                                                ...
                                                <ul class="more-dropdown">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)" class="comment-delete"
                                                           id="<?php echo e($post->newest_comment->id); ?>">Delete comment</a>
                                                    </li>
                            ...
                            <form class="comment-form inline-items">
                                ...
                                <button id="btn_comment_<?php echo e($post->id); ?>" class="btn btn-md-2 btn-primary">Post Comment
                                </button>
