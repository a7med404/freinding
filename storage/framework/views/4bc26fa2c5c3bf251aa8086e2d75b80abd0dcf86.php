    ...
    <div class="row">
        ...
        <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
            <form method="post" class="needs-validation" novalidate id="steptwo" enctype="multipart/form-data"
                  action="<?php echo e(url('updateusertwo')); ?>">
                <?php echo csrf_field(); ?>
                <div class="ui-block">
                        ...
                        <div class="row">
                            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="imgupload" style="text-align: center">
                                    ...
                                    <img src="<?php echo e(asset('olympus/img/avatar-icon.png')); ?>" class="classimg" id="idimage">
                        ...
                        <div class="row">
                            <div class="col col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="form-group date-time-picker label-floating">
                                    ...
                                    <input class="birth" placeholder="" name="datetimepicker" value="10/24/1984">
