            ...
            <div class="col col-12 col-xl-12 col-lg-12 col-md-12 col-sm-12">
               ...
               <div class="or"></div>
                <a href="#" class="btn btn-lg bg-facebook full-width btn-icon-left">
                    <i class="fab fa-facebook-f" aria-hidden="true"></i>Login with Facebook
                </a>
                ...
                <p>Don’t you have an account?
                    <a href="<?php echo e(route('register')); ?>">Register Now!</a> it’s really simple and you can start enjoing all the benefits!
                </p>
            </div>
        </div>
    </form>
