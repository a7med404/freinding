...
<!--        <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
        ...
        <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
            ...
            <div class="form-group label-floating">
                ...
                <?php echo Form::text('occupation', $user->occupation, array('placeholder' => 'Jop Title','id'=>'occupation','class' => '  form-control')); ?>
        ...
        <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
            <div class="form-group label-floating is-select">
                ...
                <?php echo Form::select('nationality',allNationals() ,$user->nationality, array('id'=>'nationality','class' => 'selectpicker form-control')); ?>
