...
<div class="form-group label-floating is-empty <?php echo e($errors->has('display_name') ? ' has-error' : ''); ?>">
    <label for="display_name" class="control-label">Display Name</label>
    <input id="user_display_name_buy" type="text" class="form-control user_display_name_buy" name="display_name" value="<?php echo e(old('display_name')); ?>" required autofocus>
