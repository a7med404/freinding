<div class="col-md-4">
    <div class="text-center">
        <div class="fileinput fileinput-new" data-provides="fileinput">
            <input id="image" name="image" type="hidden" value="<?php echo e($image); ?>">
            <?php if($image == Null): ?>
            ...
            <a href="<?php echo e(URL::asset('filemanager/dialog.php?type=1&akey=admin_panel&field_id=image')); ?>" class="btn iframe-btn btn-success fa fa-download" type="button"></a>
            <?php else: ?>
            <a href="<?php echo e(URL::asset('filemanager/dialog.php?type=0&akey=user&field_id=image')); ?>" class="btn iframe-btn btn-success fa fa-download" type="button"></a>
            <?php endif; ?>
            <a class="btn btn-danger fa fa-remove  remove_image_link" type="button"></a>
            <!--            <div class="fileinput-new thumbnail img-file">
                            <img src="<?php echo e(asset('css/admin/img/authors/avatar.jpg')); ?>" width="200" class="img-responsive" height="150" alt="riot">
                        </div>
