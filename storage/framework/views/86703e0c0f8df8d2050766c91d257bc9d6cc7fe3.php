...
<meta name="owner" content="<?php echo e(config('app.name', 'Project')); ?>">
...
<meta property="og:site_name" content="<?php echo e(config('app.name', 'Project')); ?>">
...
<meta name="twitter:site" content="<?php echo e(config('app.name', 'Project')); ?>">
