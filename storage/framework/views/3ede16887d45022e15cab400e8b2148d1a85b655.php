    ...
    <div class="pull-right">
        <ol class="breadcrumb">
            ...
            <?php if(Auth::user()->can('access-all', 'user-all','user-list')): ?>
                <li>
                    <a class="active" href="<?php echo e(route('admin.users_ids.index')); ?>">User IDS List</a>
                </li>
        <?php endif; ?>
    ...
    <div class="modal fade" id="verify-modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title">verify ID</h4>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <button id="confirm-verify" type="button" class="btn btn-default" data-dismiss="modal">verify</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '.radimg', function(event){
                ...
                var title_h=' verify ID image'+': '+$(this).attr('data-name');
