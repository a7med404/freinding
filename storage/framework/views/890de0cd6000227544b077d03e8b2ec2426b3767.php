    ...
    <section class="sidebar ">
        <div class="page-sidebar  sidebar-nav">
            ...
            <ul id="menu" class="page-sidebar-menu">
                ...
                <?php if($user_all == 1): ?>
                <li <?php if($name_list=='users' || $name_list=='roles'): ?>class="active"<?php endif; ?>  >
                    <a href="#">
                    ...
                    <ul class="sub-menu">
                        <?php if($access_all == 1): ?>
<!--                        <li><a href="<?php echo e(route('admin.roles.create')); ?>">
                                <i class="fa fa-plus-square"></i> <span>Add Role</span> 
                            </a></li>-->
                        <li><a <?php if($name_list=='roles'): ?>class="active" id="active" <?php endif; ?> href="<?php echo e(route('admin.roles.index')); ?>">
                                <i class="fa fa-user-secret"></i> <span> Roles Users</span> 
                            </a></li>
                        <?php endif; ?>
<!--                        <li><a href="<?php echo e(route('admin.users.create')); ?>">
                                <i class="fa fa-plus-square"></i> <span>Add New User</span> 
                            </a></li>-->
                        <li <?php if($name_list=='users'): ?>class="active" id="active" <?php endif; ?> ><a href="<?php echo e(route('admin.users.index')); ?>">
                                <i class="fa fa-users"></i> <span>Users List</span> 
                            </a></li>
<!--                        <li><a href="<?php echo e(route('admin.users.search')); ?>">
                                <i class="fa fa-search"></i> <span>Users Search</span> 
                            </a></li>-->
                            <li <?php if($name_list=='users_ids'): ?>class="active" id="active" <?php endif; ?> ><a href="<?php echo e(route('admin.users_ids.index')); ?>">
                                    <i class="fa fa-users"></i> <span>Users IDS</span>
                                </a></li>
                ...
                <?php endif; ?>
                <?php if($access_all == 1): ?>
                <li <?php if(in_array($name_list,['statisticsregisters','statisticsusers','statisticslifetime','statisticsagegender'])): ?>class="active"<?php endif; ?>  >
                    <a href="#">
                    ...
                    <ul class="sub-menu">
                        <li <?php if($name_list=='statisticsusers'): ?>class="active" id="active" <?php endif; ?> ><a href="<?php echo e(route('admin.statisticsusers')); ?>">
                                <i class="fa fa-users"></i> <span>Public Statistics</span> 
                            </a></li>
                        <li <?php if($name_list=='statisticsregisters'): ?>class="active" id="active" <?php endif; ?> ><a href="<?php echo e(route('admin.statisticsregisters')); ?>">
                                <i class="fa fa-rocket"></i> <span>Registration Period Type</span> 
                            </a></li>
                        <li <?php if($name_list=='statisticslifetime'): ?>class="active" id="active" <?php endif; ?> ><a href="<?php echo e(route('admin.statisticslifetime')); ?>">
                                <i class="fa fa-fire"></i> <span>Lifetime type</span> 
                            </a></li>
                        <li <?php if($name_list=='statisticsagegender'): ?>class="active" id="active" <?php endif; ?> ><a href="<?php echo e(route('admin.statisticsagegender')); ?>">
                ...
                <?php if($access_all == 1): ?>
                    <li <?php if(in_array($name_list,['stats'])): ?>class="active"<?php endif; ?>>
                        <a href="#">
