                            ...
                            <div class="ui-block-content">
								...
								<span>
									Profile Lifetime
                                        ...
                                        <div class="count-stat"><?php echo e($account_lifetim); ?> Day
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="ui-block-content">
								...
								<span>
									Average Sessions Number by day
                                        ...
                                        <?php if(count($sessionsnum)!=0): ?>
                                            <div class="count-stat"><?php echo e($count/count($sessionsnum)); ?> Sessions</div>
                                        <?php else: ?>
								...
								<span>
									Avg Sessions Duration By Day
                                        ...
                                        <?php if(count($averages)!=0): ?>
                                            <div class="count-stat"><?php echo e($countav/count($averages)); ?> Minutes</div>
                                        <?php else: ?>
