                                ...
                                <ul>
                                    <li class="cart-product-item">
                                        <div class="product-thumb">
                                            <img src="<?php echo e(asset('olympus/img/product1.png')); ?>" alt="product">
                                        </div>
                                    ...
                                    <li class="cart-product-item">
                                        <div class="product-thumb">
                                            <img src="<?php echo e(asset('olympus/img/product2.png')); ?>" alt="product">
                                        </div>
                                        <div class="product-content">
                                            <h6 class="title">Friending Orange Shirt</h6>
                                            <ul class="rait-stars">
                                                <li>
                                                    <i class="fa fa-star star-icon c-primary" aria-hidden="true"></i>
                                                </li>
