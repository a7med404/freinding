            ...
            <table class="table table-bordered table-striped" id="users">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a data-pk="1" class="editable  data_form" data-id="nationality" data-title="Edit Nationality"><?php echo nationalityData($user->nationality); ?></a>
                        <div class="hidden nationality_div">   
                            <?php echo Form::select('nationality',allNationals() ,null, array('id'=>'nationality','class' => ' hidden select2 form-control')); ?>

                        </div>
                        <?php else: ?>
                        <?php echo Form::select('nationality',allNationals() ,null, array('id'=>'nationality','class' => 'select2 form-control')); ?>
...
<!--                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a data-pk="1" class="editable  data_form" data-id="address" data-title="Edit City"><?php echo e($user->address); ?></a>
                        <?php echo Form::text('address', null, array('placeholder' => 'Your City','id'=>'address','class' => ' hidden form-control')); ?>

                        <?php else: ?>
                        <?php echo Form::text('address', null, array('placeholder' => 'Your City','id'=>'address','class' => '  form-control')); ?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a data-pk="1" class="editable  data_form" data-id="occupation" data-title="Edit Jop Title"><?php echo $user->occupation; ?></a>
                        <?php echo Form::text('occupation', null, array('placeholder' => 'Jop Title','id'=>'occupation','class' => ' hidden form-control')); ?>

                        <?php else: ?>
                        <?php echo Form::text('occupation', null, array('placeholder' => 'Jop Title','id'=>'occupation','class' => '  form-control')); ?>
