$(document).ready(() => {
    ...
    $('#myNewPost').submit((e) => {
        ...
        if ($('#choosephoto').children().length || $.trim($('#textpost').val())) {
            ...
            const $edit_post_url = clickedItem.data('edit-post');
            const $get_post_url = clickedItem.data('get-post');
            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    if (data['success']) {
                        ...
                        'data-url="' + $edit_post_url + '" data-get-post="' + $get_post_url + '">Edit Post</a>' +
                        '</li>' +
                        ' <li>' +
                        ...
                        '</div>' +
                        '</div>' +
                        '<p id="text-newpost'+data.newpost.id+'" style="word-wrap: break-word;">' + textOfPost + '</p>' +
                        $photos +
