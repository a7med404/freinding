...
//	'base_url' => ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] && ! in_array(strtolower($_SERVER['HTTPS']), array( 'off', 'no' ))) ? 'https' : 'http') . '://' . $_SERVER['HTTP_HOST'],
	...
	*/
	...
	'copy_cut_max_size'                       => 250,   //100
	// defines file count limit for paste / operation
	// set 'FALSE' for no limit
	'copy_cut_max_count'                      => 250,//200,
	...
	*******************/
	...
	'fixed_image_creation_to_append'          => array('-w-1600-h-800' ,'-w-600-h-400' , '-w-800-h-530','-w-1014-h-197' , '-w-194-h-197', '-w-1600-h-200'), //name to appendon filename
	'fixed_image_creation_width'              => array( 1600 , 600 , 800,1014,194,1600), //width of image (you can leave empty if you set height)
	'fixed_image_creation_height'             => array(800 , 400 , 530,197,197,200), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
	...
	#                          4 / crop = resize and crop;
	*/
	'fixed_image_creation_option'             => array('crop' , 'crop' , 'crop' , 'crop' , 'crop', 'crop'), //set the type of the crop
	...
	'relative_path_from_current_pos'          => array( './thumbs' , './thumbs' , './thumbs', './thumbs' , './thumbs', './thumbs'), //relative path of the image folder from the current position on upload folder
	'relative_image_creation_name_to_prepend' => array( '' , '' , '', '' , '', ''), //name to prepend on filename
	'relative_image_creation_name_to_append'  => array( '-w-1600-h-800' ,'-w-600-h-400' , '-w-800-h-530','-w-1014-h-197' , '-w-194-h-197', '-w-1600-h-200'), //name to append on filename
	'relative_image_creation_width'           => array( 1600 , 600 , 800,1014,194,1600), //width of image (you can leave empty if you set height)
	'relative_image_creation_height'          => array(800 , 400 , 530,197,197,200), //height of image (you can leave empty if you set width)
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
	...
	#                          4 / crop= resize and crop;
	*/
	'relative_image_creation_option'          => array('crop' , 'crop' , 'crop', 'crop' , 'crop', 'crop'), //set the type of the crop
